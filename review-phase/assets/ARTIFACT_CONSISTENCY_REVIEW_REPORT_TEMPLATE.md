...
- `next_step_type`: `CREATE_PLAN | UPDATE_PLAN | CREATE_ARCHITECTURE | UPDATE_ARCHITECTURE | CREATE_ADR | UPDATE_ADR | UPDATE_ROADMAP | UPDATE_PRD | REQUEST_MISSING_SOURCE_ARTIFACT | SPLIT_REVIEW_SCOPE | RUN_IMPLEMENTATION | RUN_REVIEW | STOP_AND_ESCALATE`
- `target`:
- `action`:
- `why_this_is_next`:
- `blocking_condition`:
